...
class Trainer:
    def __init__(self, num_layers, r1, r2, num_f_maps, input_dim, num_classes, channel_masking_rate, op):
    ...
    def train(self, save_dir, batch_gen, num_epochs, batch_size, learning_rate, batch_gen_tst=None):
        ...
        for epoch in range(num_epochs):
            ...
            while batch_gen.has_next():
                ...
                curvature_tensor = batch_gen.load_curvature(vids)
...
#                                                  batch_target.tolist(), predicted.tolist())
                ...
                print(f"Save the prediction file on {results_dir}/{f_name}")
